    ...
    public Main() {
        ...
        switch (menu) {
            ...
            case 3:
                ...
                codeU = a1.toString() + b1.toString() + '-' + c1.toString() + d1.toString() + e.toString() + f1.toString();
                ...
                do {
                    ...
                    salaryU = scan.nextLine();
                } while (!occupationU.equals("Manager") && !occupationU.equals("Supervisor") && !occupationU.equals("Admin"));
            ...
            case 4:
                ...
                break;
            default:
                System.out.println("Choose the right option yo!");
                break;
            }
        } while (true);
    }
